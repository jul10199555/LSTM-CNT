...
# Load CSV
#df = pd.read_csv("data/CN_F_D_S6_CLS.csv")
df = pd.read_csv("data/CN_F_D_S1_dR_R0.csv")
...
R_measured = df.loc[:, " 9-7p (6016)"].values  # Default = 25
...
ax.set_title("LSTM Resistance Prediction")
