...
seq_length = 10  # Used last given values to predict the "next one"
LSTM_activation_func = 'relu' # or 'tanh'
LSTM_mem_cells = 50 # number of units (a.k.a. hidden size / memory cells)
LSTM_epochs = 250 # total of training cycles
